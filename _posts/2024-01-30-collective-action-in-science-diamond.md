...
We recommend watching [this recent academic workshop]((https://www.youtube.com/watch?app=desktop&v=XmttiQnlJfw&feature=youtu.be)) organized by the Donders Institute at Radboud University) focusing on current status of academic publishing. The workshop host speakers studying scholar publishing, policy makers, and researchers who are working to improve academic publishing.
...
* [Transactions on Graph Data and Knowledge](https://drops.dagstuhl.de/entities/journal/TGDK) (computer science)
